...
const gamepad = {
    init: function (gpad) {
            ...
            associateEvent: function (eventName, callback, type) {
                if (eventName.match(/^button\d+$/)) {
                    ...
                    if (buttonId >= 0 && buttonId < this.buttons) {
                        ...
                        (0, tools_1.error)(constants_1.MESSAGES.INVALID_BUTTON(eventName));
                    }
                }
        ...
        for (let x = 0; x < gamepadPrototype.buttons; x++) {
            gamepadPrototype.buttonActions[x] = (0, tools_1.emptyEvents)();
        }
        for (let x = 0; x < gamepadPrototype.axes; x++) {
            gamepadPrototype.axesActions[x] = {
                down: (0, tools_1.emptyEvents)(),
                left: (0, tools_1.emptyEvents)(),
                right: (0, tools_1.emptyEvents)(),
                up: (0, tools_1.emptyEvents)()
            };
